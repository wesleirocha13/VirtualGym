 ...
 * @author Dudu
 */
public class PesquisaExercicioFichaController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(PesquisaExercicioFichaController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
